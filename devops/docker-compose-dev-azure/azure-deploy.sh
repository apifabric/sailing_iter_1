...
resourcename="sailingiter1"  # lower case, only
resourcegroup="sailingiter1_rg"
...
# git clone https://github.com/apilogicserver/sailingiter1.git
# cd sailingiter1
...
az group create --name sailingiter1_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group sailingiter1_rg --sku S1 --is-linux
az container create --resource-group sailingiter1_rg --name sailingiter1 --image apilogicserver/sailingiter1:latest --dns-name-label sailingiter1 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//sailingiter1.westus.azurecontainer.io:5656'

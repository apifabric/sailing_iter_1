...
@Component({
  selector: 'Sailboat-home',
  templateUrl: './Sailboat-home.component.html',
  styleUrls: ['./Sailboat-home.component.scss']
})
export class SailboatHomeComponent implements AfterViewInit {

...
@Component({
  selector: 'ServiceSchedule-home',
  templateUrl: './ServiceSchedule-home.component.html',
  styleUrls: ['./ServiceSchedule-home.component.scss']
})
export class ServiceScheduleHomeComponent implements AfterViewInit {

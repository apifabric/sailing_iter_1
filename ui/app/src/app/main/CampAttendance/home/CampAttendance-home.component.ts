...
@Component({
  selector: 'CampAttendance-home',
  templateUrl: './CampAttendance-home.component.html',
  styleUrls: ['./CampAttendance-home.component.scss']
})
export class CampAttendanceHomeComponent implements AfterViewInit {

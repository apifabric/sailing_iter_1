...
@Component({
  selector: 'RacingSchedule-home',
  templateUrl: './RacingSchedule-home.component.html',
  styleUrls: ['./RacingSchedule-home.component.scss']
})
export class RacingScheduleHomeComponent implements AfterViewInit {

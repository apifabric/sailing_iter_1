...
@Component({
  selector: 'SailingEvent-home',
  templateUrl: './SailingEvent-home.component.html',
  styleUrls: ['./SailingEvent-home.component.scss']
})
export class SailingEventHomeComponent implements AfterViewInit {

...
@Component({
  selector: 'CampPriceList-home',
  templateUrl: './CampPriceList-home.component.html',
  styleUrls: ['./CampPriceList-home.component.scss']
})
export class CampPriceListHomeComponent implements AfterViewInit {

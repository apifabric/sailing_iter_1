...
@Component({
  selector: 'JuniorCamper-home',
  templateUrl: './JuniorCamper-home.component.html',
  styleUrls: ['./JuniorCamper-home.component.scss']
})
export class JuniorCamperHomeComponent implements AfterViewInit {

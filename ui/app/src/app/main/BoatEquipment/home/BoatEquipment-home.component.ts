...
@Component({
  selector: 'BoatEquipment-home',
  templateUrl: './BoatEquipment-home.component.html',
  styleUrls: ['./BoatEquipment-home.component.scss']
})
export class BoatEquipmentHomeComponent implements AfterViewInit {

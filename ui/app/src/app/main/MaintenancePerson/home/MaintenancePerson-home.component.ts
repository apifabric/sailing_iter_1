...
@Component({
  selector: 'MaintenancePerson-home',
  templateUrl: './MaintenancePerson-home.component.html',
  styleUrls: ['./MaintenancePerson-home.component.scss']
})
export class MaintenancePersonHomeComponent implements AfterViewInit {
